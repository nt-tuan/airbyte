...
import pytest
from source_tiktok_shop.source import TiktokShopStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TiktokShopStream, "path", "v0/example_endpoint")
    mocker.patch.object(TiktokShopStream, "primary_key", "test_primary_key")
    mocker.patch.object(TiktokShopStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = TiktokShopStream()
